...
INSERT INTO `Coures` VALUES (4, 'java基础', 'java基础的描述', 'java基础的课程详情', 'gj', 0, 0, 0, 'courses/2018/01/2.jpg', 5, '2018-01-06 13:18:52.000000', 7, 1, 'java课程类别是吧', '课程标签是吧', 'java课程须知是吧', '能学到什么是吧', 0);
...
INSERT INTO `Coures` VALUES (8, 'C语言入门到放弃', '课程描述是吧', '<p>&nbsp; &nbsp; 课程详情是吧<img src=\"/Banner/course/image/LIVE_20180107020318.gif\" alt=\"LIVE.gif\"/></p><p style=\"line-height: 16px;\"><img style=\"vertical-align: middle; margin-right: 2px;\" src=\"http://127.0.0.1:8000/static/ueditor/dialogs/attachment/fileTypeImages/icon_jpg.gif\"/><a style=\"font-size:12px; color:#0066cc;\" href=\"/Banner/courses/file/LIVE_20180107020329.gif\" title=\"LIVE.gif\">LIVE.gif</a></p><p><br/></p>', 'cj', 0, 0, 1, 'courses/2018/01/9.jpg', 8, '2018-01-06 13:23:33.000000', 8, 2, '课程类别', 'C语言开发', '课程须知', '能学到什么', 0);
COMMIT;
...
CREATE TABLE `EmailVerifyRecord` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=64 DEFAULT CHARSET=utf8 COLLATE=utf8_croatian_ci;
...
) ENGINE=InnoDB AUTO_INCREMENT=358 DEFAULT CHARSET=utf8 COLLATE=utf8_croatian_ci;

-- ----------------------------
-- Records of captcha_captchastore
-- ----------------------------
BEGIN;
INSERT INTO `captcha_captchastore` VALUES (357, 'ZWAJ', 'zwaj', 'da9f9573e88db499426ea3d91419d108232dd5d6', '2018-01-06 15:28:53.312449');
COMMIT;
...
INSERT INTO `users_userprofile` VALUES (2, 'btmeiju@126.com', 'pbkdf2_sha256$36000$S5volnxlsdGl$kV8g8V7VMv1rVstWnwN/HqzboAectfZCqs4l74IOpGY=', '2018-01-06 00:28:40.301326', 0, '', '', 'btmeiju@126.com', 0, 1, '2018-01-06 00:05:57.979100', '哈哈哈哈', '2018-01-01', '1111111111', '1878888888', 'image/2018/01/default_middile_2_WZ1559E_yWcw4w1.png', 'male', 1);
COMMIT;
